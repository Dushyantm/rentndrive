<?php
    ...
    <div class="w3-panel w3-card w3-black"><p>w3-card</p></div>
      <div class="w3-panel w3-card-2 w3-black"><p>w3-card-2</p></div>
    <div class="w3-panel w3-card-4 w3-black"><p>w3-card-4</p></div>
      table
...
<?php
      ...
      $result = mysqli_query($conn, $sql);
      ?>
      <div class="w3-panel w3-card-4 w3-black"><p>Car ID Reg ID....Car name.... Car type....  Rental Price....Status</p></div>
      <div class="w3-panel w3-card-2 w3-black"><p><?php 
      if (mysqli_num_rows($result) > 0) {
          while($row = mysqli_fetch_assoc($result)) {
