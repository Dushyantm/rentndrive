...
<body>
	...
	<div class="w3-bar w3-black w3-card w3-large">
  		<a href="#" class="w3-bar-item w3-button w3-grey w3-mobile"><i class="w3-margin-right"></i>Car Rental System</a>
  		<a href="carlist.php" class="w3-bar-item w3-button">Cars & Pricing Info</a>
...
<header class="w3-container w3-grey w3-center" style="padding:85px 16px">
  <p class="w3-xxlarge" style="color:#fff">Rent Cars at low Prices</p>
  <p class="w3-medium" style="color:#fff">If you are a new user, click Register Yourself. Else Please login to visit your profile.</p>
  <a href="register.php" class="w3-button w3-black w3-padding-large w3-large w3-margin-top w3-hover-red">Register</a>
  <a href="userlogin.php" class="w3-button w3-black w3-padding-large w3-large w3-margin-top w3-hover-red">User login</a>
</header>
...
<div class="w3-container w3-light-grey" style="padding:40px 16px" id="about">
  ...
  <div class="w3-row-padding w3-grayscale " style="margin-left:650px ">
...
<div class="w3-black" style="padding:20px 16px">  
  
 <p class="w3-center">WDL Project    </p>
</div>
