...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container" style="margin-left:16%">
  ...
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      ...
      echo'<th>Car Type ID</th><th>Car Type name</th><th>In Stock (Units)</th><th>In Repair (Units)</th>';
      while($data = mysqli_fetch_array($result))
      {

      echo'<tr>';
      echo '<td>'.$data['car_type_id'].'</td><td>'.$data['car_type_name'].'</td><td>'.$data['in_stock'].'</td><td>'.$data['in_repair'].'</td>';
      echo'</tr>';
      }
