...
<body>
	...
	<div class="w3-bar w3-black w3-card w3-large">
  		<a href="index.php" class="w3-bar-item w3-button w3-black w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Vehicle Rental System</a>
...
<footer class="w3-container w3-black w3-card w3-margin-top">  
